    ...
    <div className="py-16 bg-gray-200 text-gray-900">
      <div className="container">
        ...
        <div className="text-left mb-12">
          <h2 className="text-4xl font-extrabold text-yellow-500">Prototipo 2</h2>
          <p className="text-lg text-gray-600 mt-2">Nuestra segunda apuesta. El futuro de Helios Race UPV.</p>
        </div>
