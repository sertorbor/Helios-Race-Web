    ...
    <div className="py-16 bg-gray-200 text-gray-900">
      <div className="container relative">
        ...
        <Button
          ...
          className="absolute top-0 right-6 md:top-4 md:right-8 bg-white text-black border-2 border-yellow-500 hover:bg-yellow-500 hover:text-black transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-yellow-400 rounded-xl"
        >
          {t('vehicles.back')}
        </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="order-1 md:order-2 relative h-[200px] md:h-[390px] rounded-xl overflow-hidden shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="relative h-[200px] md:h-[390px] rounded-xl overflow-hidden shadow-lg"
          >
