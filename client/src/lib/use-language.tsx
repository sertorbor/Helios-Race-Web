...
const translations = {
  ...
  es: {
    ...
    'home.features.innovation.description': 'Exploramos nuevas fronteras en aerodinámica, eficiencia energética y movilidad solar. Utilizando tecnologías de vanguardia, optimizamos el rendimiento y construimos un futuro hacia las energías renovables.',
