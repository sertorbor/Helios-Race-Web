...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Driving the next generation of <span class="text-yellow-300 font-semibold">solar-powered mobility</span> with a commitment to <span class="text-yellow-300 font-semibold">sustainable innovation</span> and cutting-edge technology.',
    ...
    'home.subtitle': 'Driving the next generation of <span class="text-yellow-300 font-semibold">solar-powered mobility</span> with a commitment to <span class="text-yellow-300 font-semibold">sustainable innovation</span> and cutting-edge technology.',
  ...
  es: {
    ...
    'hero.subtitle': 'Impulsando la próxima generación de <span class="text-yellow-300 font-semibold">movilidad solar</span> con un compromiso con la <span class="text-yellow-300 font-semibold">innovación sostenible</span> y tecnología de vanguardia.',
    ...
    'home.subtitle': 'Impulsando la próxima generación de <span class="text-yellow-300 font-semibold">movilidad solar</span> con un compromiso con la <span class="text-yellow-300 font-semibold">innovación sostenible</span> y tecnología de vanguardia.',
